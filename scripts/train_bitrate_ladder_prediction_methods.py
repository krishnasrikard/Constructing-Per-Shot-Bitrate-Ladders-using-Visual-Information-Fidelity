...
def train_crossoverbitrates(
	...
	for i in range(len(Resolutions)-1):
		...
		X_train, y_train = bitrate_ladder_prediction_dataset_functions.LowLevelFeatures_CrossOverBitrates_Dataset(
			# Files
		...
		X_valid, y_valid = bitrate_ladder_prediction_dataset_functions.LowLevelFeatures_CrossOverBitrates_Dataset(
			# Files
...
def train_metadata(
	...
	## Training, Validation and Test Datasets
	X_train, y_train = bitrate_ladder_prediction_dataset_functions.Metadata_Quality_Dataset(
		# Files
		video_filenames=Train_Video_Files,
	...
	X_valid, y_valid = bitrate_ladder_prediction_dataset_functions.Metadata_Quality_Dataset(
		# Files
		video_filenames=Valid_Video_Files,
	...
	y_pred_Results, y_Results, _ = bitrate_ladder_prediction_dataset_functions.Predict_Metadata_Quality(
		# Model
		Model=test_model,
...
def train_low_level_features(
	...
	## Training, Validation and Test Datasets
	X_train, y_train = bitrate_ladder_prediction_dataset_functions.LowLevelFeatures_Quality_Dataset(
		# Files
		video_filenames=Train_Video_Files,
	...
	X_valid, y_valid = bitrate_ladder_prediction_dataset_functions.LowLevelFeatures_Quality_Dataset(
		# Files
		video_filenames=Valid_Video_Files,
	...
	# Performance on Test Set
	print("Performance on Test Set")
	y_pred_Results, y_Results, _ = bitrate_ladder_prediction_dataset_functions.Predict_LowLevelFeatures_Quality(
		# Model
		Model=test_model,
...
def train_vif_features(
	...
	## Training, Validation and Test Datasets
	X_train, y_train = bitrate_ladder_prediction_dataset_functions.VIFFeatures_Quality_Dataset(
		# Files
		video_filenames=Train_Video_Files,
	...
	X_valid, y_valid = bitrate_ladder_prediction_dataset_functions.VIFFeatures_Quality_Dataset(
		# Files
		video_filenames=Valid_Video_Files,
	...
	# Performance on Test Set
	print("Performance on Test Set")
	y_pred_Results, y_Results, _ = bitrate_ladder_prediction_dataset_functions.Predict_VIFFeatures_Quality(
		# Model
		Model=test_model,
	...
	plot_functions.Plot_Predictions(
		...
		y_Results=y_Results,
		Resolutions=Resolutions_Considered,
		plot_save_path=os.path.join(results_dir, "quality_prediction_plots", "vif_features_{}.png".format(vif_approach_number)),
		show=False,
		save_results=os.path.join(results_dir, "quality_prediction_results", "vif_features_{}.npy".format(vif_approach_number)),
	)
...
def train_low_level_features_vif_features(
	...
	## Training, Validation and Test Datasets
	X_train, y_train = bitrate_ladder_prediction_dataset_functions.LowLevelFeatures_VIFFeatures_Quality_Dataset(
		# Files
		video_filenames=Train_Video_Files,
	...
	X_valid, y_valid = bitrate_ladder_prediction_dataset_functions.LowLevelFeatures_VIFFeatures_Quality_Dataset(
		# Files
		video_filenames=Valid_Video_Files,
	...
	# Performance on Test Set
	print("Performance on Test Set")
	y_pred_Results, y_Results, _ = bitrate_ladder_prediction_dataset_functions.Predict_LowLevelFeatures_VIFFeatures_Quality(
		# Model
		Model=test_model,
	...
	plot_functions.Plot_Predictions(
		...
		y_Results=y_Results,
		Resolutions=Resolutions_Considered,
		plot_save_path=os.path.join(results_dir, "quality_prediction_plots", "low_level_features_vif_features_{}.png".format(vif_approach_number)),
		show=False,
		save_results=os.path.join(results_dir, "quality_prediction_results", "low_level_features_vif_features_{}.npy".format(vif_approach_number)),
	)
...
def main(
	...
	# Creating Directories
	os.makedirs(os.path.join(results_dir, "Bitrate_Ladder_Prediction", "models"), exist_ok=True)
	os.makedirs(os.path.join(results_dir, "Bitrate_Ladder_Prediction", "quality_prediction_results"), exist_ok=True)
	os.makedirs(os.path.join(results_dir, "Bitrate_Ladder_Prediction", "quality_prediction_plots"), exist_ok=True)
	...
	train_metadata(
		...
		# Path
		results_dir=os.path.join(results_dir, "Bitrate_Ladder_Prediction"),
