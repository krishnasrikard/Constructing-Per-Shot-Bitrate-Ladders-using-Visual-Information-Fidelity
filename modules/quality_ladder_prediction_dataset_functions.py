...
# Predict Cross-Over Qualities
def Calculate_CrossOver_Qualities(
	RQ_pairs:dict=None,
...
# Extract Cross-Over Qualities
def Extract_CrossOver_Qualities(
	codec:str,
	preset:str,
	quality_metric:str,
	...
	for video_file in video_filenames:
		# Cross-Over Qualities Information
		...
		CrossOver_Qualities[video_file] = Calculate_CrossOver_Qualities(
			RQ_pairs=RQ_pairs,
			Resolutions=Resolutions_Considered
		)

	return CrossOver_Qualities


# Creating Dataset for Cross-Over Quality Prediction
def LowLevelFeatures_CrossOverQualities_Dataset(
	codec:str,
	preset:str,
	quality_metric:str,
	features_names:list,
	...
	CrossOver_Qualities = Extract_CrossOver_Qualities(
		codec=codec,
		preset=preset,
		quality_metric=quality_metric,
	...
	for video_file in video_filenames:
		...
		Targets.append(CrossOver_Qualities[video_file])
...
# Creating Datasets for Bitrate Prediction
def Metadata_Bitrate_Dataset(
	codec:str,
	preset:str,
	quality_metric:str,
	video_filenames:list,
...
def LowLevelFeatures_Bitrate_Dataset(
	codec:str,
	preset:str,
	quality_metric:str,
	features_names:list,
...
def VIFFeatures_Bitrate_Dataset(
	codec:str,
	preset:str,
	quality_metric:str,
	video_filenames:list,
...
def LowLevelFeatures_VIFFeatures_Bitrate_Dataset(
	codec:str,
	preset:str,
	quality_metric:str,
	features_names:list,
...
# Bitrate Prediction Functions
def Predict_Metadata_Bitrate(
	Model:any,
	codec:str,
	preset:str,
	quality_metric:str,
	...
	Returns:
		...
		quality_Results (np.array): Corresponding quality values
	"""
	# Results
	...
	quality_Results = -np.inf*np.ones((len(video_filenames), len(Resolutions_Considered), len(CRFs_Considered)))
	...
	for i,video_file in enumerate(video_filenames):
		for j,res in enumerate(Resolutions_Considered):
			...
			quality_Results[i,j,:y_pred.shape[0]] = Meta_Information[video_file][:,1]

	return y_pred_Results, y_Results, quality_Results


def Predict_LowLevelFeatures_Bitrate(
	Model:any,
	codec:str,
	preset:str,
	quality_metric:str,
	...
	"""
	Predicting Bitrate Estimations of each of the video files per each resolution and crf value. The order of resolutions values matter and along crfs axis, the values are considered from highest to lowest crf or in ascending order of quality.
	Args:
		Model (any): sklearn model used for evaluation.
		codec (str): Codec used to generate RQ points that need to be extracted.
		preset (str): Preset used to generate RQ points that need to be extracted.
	...
	for i,video_file in enumerate(video_filenames):
		for j,res in enumerate(Resolutions_Considered):
			...
			# Dataset with video_file and res
			X,y = LowLevelFeatures_Bitrate_Dataset(
				codec=codec,
				preset=preset,
				quality_metric=quality_metric,
				features_names=features_names,
...
def Predict_VIFFeatures_Bitrate(
	Model:any,
	codec:str,
	preset:str,
	quality_metric:str,
	...
	for i,video_file in enumerate(video_filenames):
		for j,res in enumerate(Resolutions_Considered):
			...
			# Dataset with video_file and res
			X,y = VIFFeatures_Bitrate_Dataset(
				codec=codec,
				preset=preset,
				quality_metric=quality_metric,
				video_filenames=[video_file],
...
def Predict_LowLevelFeatures_VIFFeatures_Bitrate(
	Model:any,
	codec:str,
	preset:str,
	quality_metric:str,
	...
	for i,video_file in enumerate(video_filenames):
		for j,res in enumerate(Resolutions_Considered):
			...
			# Dataset with video_file and res
			F = LowLevelFeatures_VIFFeatures_Bitrate_Dataset(
				codec=codec,
				preset=preset,
				quality_metric=quality_metric,
				features_names=features_names,
