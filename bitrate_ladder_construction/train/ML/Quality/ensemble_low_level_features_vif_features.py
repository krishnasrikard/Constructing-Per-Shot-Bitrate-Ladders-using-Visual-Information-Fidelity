## Predicting Quality using Ensemble of Low-Level Features and VIF Features and Meta Data using Machine Learning Models
...
def train_approach(
	...
	X_train, y_train = dataset_evaluation_functions.LowLevelFeatures_VIFFeatures_Quality_Dataset(
	...
	X_valid, y_valid = dataset_evaluation_functions.LowLevelFeatures_VIFFeatures_Quality_Dataset(
		features_names=features_names,
		vif_setting=vif_setting,
		vif_features_list=vif_features_list,
	...
	test_model = ExtraTreesRegressor(n_estimators=1250, random_state=2, max_depth=12)
	...
	y_pred_Results, y_Results, bitrate_Results = dataset_evaluation_functions.Predict_LowLevelFeatures_VIFFeatures_Quality(
		Model=test_model,
	...
	plot_functions.Plot_Predictions(y_pred_Results=y_pred_Results, y_Results=y_Results, Resolutions=arguments["Resolutions_Considered"], plot_save_path="plots/ensemble_llf_viff_approach_{}_valid.png".format(approach_number), show=False, save_results="results/ensemble_llf_viff_approach_{}_valid.npy".format(approach_number))
	...
	plot_functions.Plot_Predictions(y_pred_Results=y_pred_Results, y_Results=y_Results, Resolutions=arguments["Resolutions_Considered"], plot_save_path="plots/ensemble_llf_viff_approach_{}_test.png".format(approach_number), show=False, save_results="results/ensemble_llf_viff_approach_{}_test.npy".format(approach_number))
...
if __name__ == "__main__":
	...
	models_path = os.path.join(home_path, "models/ML/Quality", "ensemble_low_level_features_vif_features")
