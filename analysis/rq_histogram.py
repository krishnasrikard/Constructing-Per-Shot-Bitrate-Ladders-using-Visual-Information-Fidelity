...
plt.hist2d(x=R,y=Q,bins=[np.arange(15,29,1),np.arange(0,105,10)],cmap="ocean_r")
plt.colorbar()
...
plt.savefig('plots/rate_quality_histogram/RQ_Histogram.png', dpi=400, bbox_inches='tight')
plt.close()
