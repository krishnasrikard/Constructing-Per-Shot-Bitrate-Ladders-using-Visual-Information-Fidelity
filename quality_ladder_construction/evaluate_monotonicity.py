...
def Evaluate_Metadata_ML_Monotonicity(video_files, codec, preset):
	# Evaluating model used for predicting bitrate trained using only metadata
	print ("-"*100)
	print ("Evaluating model used for predicting bitrate trained using only metadata")
	print ()
	...
	for video_file in video_files:
		...
		state = quality_ladder_functions.Bitrate_Monotonicity(
			Model=Model,
			X = X,
			evaluation_qualities=defaults.evaluation_qualities
		)
...
def Evaluate_LLF_ML_Monotonicity(video_files, codec, preset):
	# Evaluating model used for predicting bitrate trained using ML and Low-Level features
	print ("-"*100)
	print ("Evaluating model used for predicting bitrate trained using ML and Low-Level features")
	print ()
...
def Evaluate_ML_VIF_Monotonicity(video_files, codec, preset):
	# Evaluating model used for predicting bitrate trained using ML and VIF-features
	print ("-"*100)
	print ("Evaluating model used for predicting bitrate trained using ML and VIF-features")
	print ()
...
def Evaluate_ML_Ensemble_LLFVIF_Monotonicity(video_files, codec, preset):
	# Evaluating model used for predicting bitrate trained using ML, Low-Level features and VIF-features
	print ("-"*100)
	print ("Evaluating model used for predicting bitrate trained using ML, Low-Level features and VIF-features")
	print ()
